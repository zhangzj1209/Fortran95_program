module sgl_util
  ...
  integer(4), save :: ufo4(4*512*512/4)
...
contains
  subroutine display()
    ...
    call sglPutBuffer(mountain,0,0,512,512)
	call sglEnableColorKey()
	call sglColorKey3i(0,0,0)
	call sglPutBuffer(ufo, x, y, 60, 60)
...
program main
  ...
  call sglPutRGBBuffer(ufo,0,0,60,60)
  call sglGetBuffer(ufo,0,0,60,60)
